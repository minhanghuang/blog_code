...
from app_user.views_blog.api.detail_data.detail_data_viewset import DetailDataViewSetBlog
...
DetailDataViewSetBlogRouter = routers.DefaultRouter() # 查看data详细信息_客户端
DetailDataViewSetBlogRouter.register('', DetailDataViewSetBlog,base_name="")
...
urlpatterns = [
    ...
    path('blog/detail-data/', include(DetailDataViewSetBlogRouter.urls)), # 查看data详细信息_客户端
